...
export class SalesFieldService {
  ...
  postdata() {
    return this.http.post(this.localUrl + 'post', this.obSalesField);
  }
  putdata() {
    return this.http.put(this.localUrl + 'put', this.obSalesField);
  }
  GetAlldata() {
    return this.http.get<SalesField[]>(this.localUrl + 'get');
  }
  Delete(index) {
