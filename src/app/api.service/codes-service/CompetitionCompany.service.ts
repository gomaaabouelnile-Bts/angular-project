...
export class CompetitionCompanyService {
  ...
  postdata()
  {
    return this.http.post(this.localUrl + 'post', this.obCompetitionCompany);
  }
  putdata()
  {
    return this.http.put(this.localUrl + 'put', this.obCompetitionCompany);
  }
  GetAlldata()
  {
    return this.http.get<srCompetitionCompany[]>(this.localUrl + 'get');
  }
  Delete(index)
  {
