...
export class CustClassService {
  ...
  postdata()
  {
    return this.http.post(this.localUrl + 'post', this.obCustClass);
  }
  putdata()
  {
    return this.http.put(this.localUrl + 'put', this.obCustClass);
  }
  GetAlldata()
  {
    return this.http.get<CustClass[]>(this.localUrl + 'get');
  }
  Deleteclass(index)
  {
