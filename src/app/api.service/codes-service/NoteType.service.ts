...
export class NoteTypeService {
  ...
  postdata() {
    return this.http.post(this.localUrl + 'post', this.obInNoteType);
  }
  putdata() {
    return this.http.put(this.localUrl + 'put', this.obInNoteType);
  }
  GetAlldata() {
    return this.http.get<InNoteType[]>(this.localUrl + 'get');
  }
  Delete(index) {
