...
export class LoginComponent implements OnInit {
  ...
  onLogin(f: NgForm) {
    ...
    this.spinner.show();
    this.isSubmitted = this.obuser.Seruser.userName === null || this.obuser.Seruser.userName === "" ?
      false : true;
    ...
    if (this.isSubmitted) {
      ...
      this.obuser.Login(this.obuser.Seruser.userName, this.obuser.Seruser.password).subscribe(res => {
        this.rowData = res;
        if (res != null && res.userName !== null && res.userName !== '') {
          ...
          sessionStorage.setItem('GroupID', res.groupId.toString());
